...
| Date | Action | Result |
|------|--------|--------|
| 2026-08-26 | Sixth pass — QNX Everywhere licence terms read directly for Chapter 04 | ⚠️ **Found an error in this course's published material.** QNX's licensing page lists *"Build or develop a product or system (e.g. as part of a product roadmap) to demonstrate to existing or potential customers"* as **permitted**; Setup Guide 02 §2 had listed customer demos as forbidden. Also confirmed: hobby/maker use may *build a product or system*; OSS is permitted only if *"publicly available at no charge"*; training material is permitted *"including if you intend to offer that material commercially"*; distribution requires a **separate** licence even for commercial holders. |
...
| Version | Date | Change |
|---------|------|--------|
| 1.5 | 2026-08-26 | Chapter 04: licence terms verified verbatim; a published error in Setup Guide 02 identified and corrected. |
