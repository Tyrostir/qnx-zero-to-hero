...
| Chapters published | **3 / 34** — Ch 00, 01, 02 📕 |
...
| Next (me) | **Chapter 03 — Why & Where QNX Is Used** (T-111) — closes Part 0 |
| Next (learner) | 📕 Read Ch 02 · **blocks V6** (build the lab) and **V7** (kill/restart a service) are both open |
